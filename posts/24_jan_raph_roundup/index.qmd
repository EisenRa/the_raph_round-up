...
::: column-margin
![Fireworks from our apartment's roof. Note: you can click images to enlarge them!](photos/fireworks1.jpg){.lightbox width="338"}
:::
...
::: {layout-ncol="3"}
![Søndermarken\
© 2024. This work is openly licensed via [CC BY-NC 4.0](https://creativecommons.org/licenses/by-nc/4.0/)](snow1.jpg){group="snow-gallery"}

![Decent snowfall (for Copenhagen)](photos/snow3.jpg){group="snow-gallery"}

![Taken by Matilda](photos/snow2.jpg){group="snow-gallery"}
:::
...
::: {layout-ncol="2"}
![Gammeldags bolle - purchased from Københavns bageri](photos/faste1.jpg){group="gammel"}

![Gammeldags bolle - cross section](photos/faste2.jpg){group="gammel"}
:::
...
::: {layout-ncol="2"}
![Avant-garde bolle - purchased from Københavns bageri (our local)](photos/faste3.jpg){group="avant"}

![Avant-garde bolle - flot snit!! (nice cross section)](photos/faste4.jpg){group="avant"}
:::
...
::: {layout-ncol="2"}
![The prodigal pie -- first bake with new setup](photos/pizza1.jpg){group="pizza"}

![The steel setup. Top shelf of oven with grill turned on for max heat ouput](photos/pizza2.jpg){group="pizza"}
:::
...
![[Frederiksberg Palace](https://en.wikipedia.org/wiki/Frederiksberg_Palace) with snow. I love the contrast between the snow/sky (cold) and palace/Danish flag (warm). 35mm, ISO 100, f / 3.2, 1/1000 sec\
